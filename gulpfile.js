...
gulp.task("uglify", ["browserify"], function (cb) {
  return gulp
    .src("./lib/pathfinding-browserified.js")
    .pipe(uglify())
...
gulp.task("scripts", ["clean", "browserify", "uglify"], function (cb) {
  return gulp
    .src(["./src/banner", "./lib/pathfinding-browserified.js"])
...
gulp.task("release", ["compile"], function (cb) {
  inquirer.prompt(
    ...
    function (result) {
      ...
      shell.exec(
        "git clone https://github.com/imor/pathfinding-bower.git release"
      );
      process.chdir("release");
      fs.writeFileSync(
        "pathfinding-browser.js",
        fs.readFileSync("../lib/pathfinding-browser.js")
      );
      fs.writeFileSync(
        "pathfinding-browser.min.js",
        fs.readFileSync("../lib/pathfinding-browser.min.js")
      );
